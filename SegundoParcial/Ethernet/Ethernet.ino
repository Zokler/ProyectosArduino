...
byte ip[] = { 192, 168, 0, 105 };                       // IP Local que usted debe configurar 
      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           client.println("<a href=\"/?button2on\"\"> Encender Foco(pin2)</a> ");           // construye en la pagina cada uno de los botones
           client.println(" | | | ");
           client.println("<a href=\"/?button2off\"\"> Apagar Foco </a><br /> ");   
           client.println("<br />");
           ...
           client.println("<hr />");
           client.println("<p>Jogio Mariana Dieguitoperro</p>");  
           client.println("<br />"); 
           client.println("</BODY>");
           client.println("</HTML>");
